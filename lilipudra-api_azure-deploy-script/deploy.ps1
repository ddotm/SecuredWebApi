<#
 ...
 .EXAMPLE
    ./deploy.ps1 -subscription "Visual Studio Premium with MSDN" -TemplateFile 'template.json' -ResourceGroupName Labs
...
if(Test-Path $ParametersFilePath) {
    New-AzResourceGroupDeployment -ResourceGroupName $ResourceGroupName -TemplateFile $TemplateFilePath -TemplateParameterFile $ParametersFilePath -NameFromTemplate 'lilipudra-api';
} else {
    New-AzResourceGroupDeployment -ResourceGroupName $ResourceGroupName -TemplateFile $TemplateFilePath -NameFromTemplate 'lilipudra-api';
}